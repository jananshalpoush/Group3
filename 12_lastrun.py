...
expName = '12'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/12_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('counting.started', globalClock.getTime(format='float'))
    # keep track of which components have finished
    countingComponents = [text, text_2, text_3]
    ...
    while continueRoutine and routineTimer.getTime() < 6.0:
        ...
        if text_3.status == NOT_STARTED and tThisFlip >= 4-frameTolerance:
            # keep track of start time/frame for later
    ...
    for thisComponent in countingComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('counting.stopped', globalClock.getTime(format='float'))
