...
expName = '5-16'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/5-16_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # keep track of which components have finished
    TestPhase1Components = [test1_image1, test1_image2, test1_image3, test1_image4, test1_sound, text_3, Test1_response]
    ...
    # keep track of which components have finished
    TestPhase2Components = [test2_image1, test2_image2, test2_image3, test2_image4, test2_sound, text_8, Test2_response]
    ...
    # keep track of which components have finished
    TestPhase3Components = [test3_image1, test3_image2, test3_image3, test3_image4, test3_sound, text_10, Test3_response]
