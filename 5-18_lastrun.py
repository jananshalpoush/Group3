...
expName = '5-18'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/5-18_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    if accuracy >= TARGET_ACCURACY:
        if TrainingGroup == 1:
            ...
            raise ValueError(f"Unexpected TrainingGroup value: {TrainingGroup}")
    else:
        if TrainingGroup == 1:
