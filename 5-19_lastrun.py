...
expName = '5-19'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/5-19_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    if total_responses > 0:
        accuracy = correctResponses / total_responses
    else:
        accuracy = 0
    ...
    for thisTestPhase1Loop in testPhase1Loop:
        ...
        testPhase1Loop.addData('Test1_response.keys',Test1_response.keys)
        if Test1_response.keys != None:  # we had a response
            testPhase1Loop.addData('Test1_response.rt', Test1_response.rt)
            testPhase1Loop.addData('Test1_response.duration', Test1_response.duration)
    ...
    for thisTestPhase2Loop in testPhase2Loop:
        ...
        testPhase2Loop.addData('Test2_response.keys',Test2_response.keys)
        if Test2_response.keys != None:  # we had a response
            testPhase2Loop.addData('Test2_response.rt', Test2_response.rt)
            testPhase2Loop.addData('Test2_response.duration', Test2_response.duration)
    ...
    for thisTestPhase3Loop in testPhase3Loop:
        ...
        testPhase3Loop.addData('Test3_response.keys',Test3_response.keys)
        if Test3_response.keys != None:  # we had a response
            testPhase3Loop.addData('Test3_response.rt', Test3_response.rt)
            testPhase3Loop.addData('Test3_response.duration', Test3_response.duration)
