...
expName = '5-20'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/5-20_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_11 = visual.TextStim(win=win, name='text_11',
        text='Welcome to the Training Phase!\nPress the number of the speaker on the keyboard. You will receive feedback on your choice.\nبه مرحله اموزش خوش امدید\nپس از شنیدن جملات شماره گوینده را وارد کنید\nپس از انتخاب پاسخ صحیح را دریافت میکنید\n',
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='Arabic',
    ...
    for thisTrainingLoopGroup2 in TrainingLoopGroup2:
        ...
        _Response2_allKeys = []
        # keep track of which components have finished
        TrainingGroup2Components = [text_11, image_11, SpeakerPicture2, image_5, image_6, Sound2, Instruction2, Response2]
        ...
        while continueRoutine:
            ...
            if image_11.status == NOT_STARTED and tThisFlip >= 5-frameTolerance:
                # keep track of start time/frame for later
            ...
            if SpeakerPicture2.status == NOT_STARTED and tThisFlip >= 5-frameTolerance:
                # keep track of start time/frame for later
            ...
            if image_6.status == NOT_STARTED and tThisFlip >= 5-frameTolerance:
                # keep track of start time/frame for later
            ...
            if Sound2.status == NOT_STARTED and tThisFlip >= 5-frameTolerance:
                # keep track of start time/frame for later
            ...
            if Instruction2.status == NOT_STARTED and tThisFlip >= 5-frameTolerance:
                # keep track of start time/frame for later
            ...
            if Response2.status == NOT_STARTED and tThisFlip >= 5-frameTolerance:
                # keep track of start time/frame for later
    ...
    for thisTestPhase1Loop in testPhase1Loop:
        ...
        # keep track of which components have finished
        TestPhase1Components = [WelcomeTest1, test1_image1, test1_image2, test1_image3, test1_image4, test1_sound, text_3, test1_response_keyboard]
    ...
    for thisTestPhase2Loop in testPhase2Loop:
        ...
        # keep track of which components have finished
        TestPhase2Components = [WelcomeTest2, test2_image1, test2_image2, test2_image3, test2_image4, test2_sound, text_8, test2_response_keyboard]
    ...
    for thisTestPhase3Loop in testPhase3Loop:
        ...
        # keep track of which components have finished
        TestPhase3Components = [WelcomeTest3, test3_image1, test3_image2, test3_image3, test3_image4, test3_sound, text_10, test3_response_keyboard]
