...
expName = '5-23'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/5-23_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # Initialize counters for each training group
    ...
    total_correct = correct_responses_group1 + correct_responses_group2 + correct_responses_group3
