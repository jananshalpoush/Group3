...
expName = '5-28'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/5-28_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisRepeated_TrainingLoopGroup1 in repeated_TrainingLoopGroup1:
        ...
        for thisTrainingLoopGroup1 in TrainingLoopGroup1:
            ...
            if len(Response1.keys) > 0:  # Check if a key was pressed
                participant_response_label = response_mapping.get(Response1.keys[0], "Invalid")
