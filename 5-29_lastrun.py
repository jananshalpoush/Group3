...
expName = '5-29'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/5-29_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    feedbackText = "Default feedback message"
    ...
    for thisRepeated_TrainingLoopGroup1 in repeated_TrainingLoopGroup1:
        ...
        for thisTrainingLoopGroup1 in TrainingLoopGroup1:
            ...
            # Check if correctResponses and total_trials are initialized
            if 'correct_responses_group1' not in globals():
                correct_responses_group1 = 0
                total_trials_group1 = 0
            
            if 'correct_responses_group2' not in globals():
                correct_responses_group2 = 0
                total_trials_group2 = 0
            
            if 'correct_responses_group3' not in globals():
                correct_responses_group3 = 0
                total_trials_group3 = 0
        ...
        if accuracy_group1 >= TARGET_ACCURACY:
            ...
            repeated_TrainingLoopGroup1.finished = True  # End the loop to proceed to the test phase
        else:
            proceed_to_test = False
            correct_responses_group1 = 0  # Reset correct responses for Group 1
            total_trials_group1 = 0  # Reset total trials for Group 1
