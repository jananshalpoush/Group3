...
expName = '5-30'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/5-30_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    TrainingGroup1 = 1  # or 2, or 3 depending on your experiment setup
    TrainingGroup2 = 2
    TrainingGroup3 = 3
    ...
    for thisRepeated_TrainingLoopGroup1 in repeated_TrainingLoopGroup1:
        ...
        for thisTrainingLoopGroup1 in TrainingLoopGroup1:
            ...
            if 'correctResponses_group1' not in globals():
                correctResponses_group1 = 0
            if 'total_trials_group1' not in globals():
                total_trials_group1 = 0
