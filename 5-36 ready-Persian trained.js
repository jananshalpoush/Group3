...
var Instruction2;
var Response2;
var FeedbackRoutine2Clock;
var FeedbackText2;
var CheckAccuracy2Clock;
...
var repeated_TrainingLoopGroup2;
function repeated_TrainingLoopGroup2LoopBegin(repeated_TrainingLoopGroup2LoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisRepeated_TrainingLoopGroup2 of repeated_TrainingLoopGroup2) {
...
var _Response2_allKeys;
var TrainingGroup2Components;
...
var continue_to_test_phases;
var FeedbackRoutine2Components;
...
function CheckAccuracy2RoutineBegin(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData("accuracy_group2", accuracy);
    psychoJS.experiment.addData("proceed_to_test", proceed_to_test);
    
    // keep track of which components have finished
    CheckAccuracy2Components = [];
    
    for (const thisComponent of CheckAccuracy2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
var _test2_response_keyboard_allKeys;
var TestPhase2Components;
