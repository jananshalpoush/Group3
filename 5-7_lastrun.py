...
expName = '5-7'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment folder/5-7_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    TrainingLoopGroup1 = data.TrialHandler(nReps=999.0, method='random', 
        ...
        trialList=data.importConditions('/Users/ohtalab2/Desktop/Experiment Folder/Monolingual Persian- Training Phase.xlsx'),
