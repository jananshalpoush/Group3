...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/Experiment2/Group2_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisRepeated_TrainingLoopGroup2 in repeated_TrainingLoopGroup2:
        ...
        # Calculate accuracy
        accuracy_group2 = correctResponses_group2 / total_trials_group2 if total_trials_group2 > 0 else 0.0
        ...
        if accuracy_group2 >= TARGET_ACCURACY:
            ...
            correctResponses_group2 = 0  # Reset score
            total_trials_group2 = 0  # Reset total trials
        
        # Print accuracy for debugging
        print(f"Accuracy: {accuracy_group2}")
