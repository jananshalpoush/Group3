...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/ohtalab2/Desktop/Experiment Folder/new with trial number and break2_lastrun.py',
    ...
    for thisRepeated_TrainingLoopGroup1 in repeated_TrainingLoopGroup1:
        ...
        for thisTrainingLoopGroup1 in TrainingLoopGroup1:
            ...
            while continueRoutine:
                ...
                remaining_time = 10 - break_timer.getTime()  # Assuming a 30-second break
                text_component.setText(f'Time remaining: {remaining_time:.1f} seconds')
                
                # End the routine after 30 seconds
